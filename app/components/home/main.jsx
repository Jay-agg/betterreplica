...
import first from "./images/first-home.webp";
import hero from "./images/hero-variant-c.webp";
        ...
        <div id="__next">
          <main class="__className_5f7ae9">
            <header class="sticky top-0 z-20 transition-all ease-in-out duration-300 bg-accentPrimary">
              <div class="bg-graph4Tertiary">
                <p class="font-normal leading-body m-0 p-0 text-textPrimary text-base text-center"></p>
              </div>
              <nav class="m-auto flex max-w-screen-2xl justify-between p-5 md:py-5 md:px-10 xl:p-5">
                ...
                <ul class="flex items-center gap-3 lg:gap-6">
                  ...
                  <li class="transition-all duration-500 ease-in">
                    <a
                  ...
                  <div class="flex flex-row flex-wrap justify-center gap-8 lg:gap-6">
                    ...
                    >
                      <div class="flex flex-col gap-6">
                        ...
                        <p class="hidden flex-1 md:flex-none text-sm text-backgroundInversePrimary md:block">
                          ...
                          deliver a Commitment Letter in a few weeks.
                          <sup>1</sup>
                        </p>
                        <div class="flex items-end justify-between">
                          <div class="group">
                    ...
                    >
                      <div class="flex flex-col gap-6">
                        ...
                        <p class="hidden flex-1 md:flex-none text-sm text-backgroundInversePrimary md:block">
                          Introducing One Day HELOC™—your express lane to
                          getting cash from your home with our Home Equity Line
                          of Credit<sup>2</sup>. Access up to 90% of your home
                          equity as cash in as little as 7 days.<sup>3</sup>
                        </p>
                        <div class="flex items-end justify-between">
                          <div class="group">
                            <svg
